...
const (
	API_KEY = "AIzaSyBX4TVlsZM_UYvy9mYFejYrtwysBO3G0FA"
)
...
func createGCMMsg(msg *Message) *GCMMsg {
	...
	// Prepare GCM message
	gcmm := &GCMMsg{}
	gcmm.Data = map[string]string{"title": title, "message": m.Content}
	gcmm.RegistrationIDs = []string{m.To}
...
func createRequest(msg *Message) *http.Request {
